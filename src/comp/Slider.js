                    ...
                    <div className="page first">
                        <div className="container flex">
                            ...
                            <div className="text_container">
                                ...
                                <p>노벨 문학상 수상 작가, 전 세계에서 사랑받는 작가 마르케스의 유고 소설
                    ...
                    <div className="page second">
                        <div className="container flex">
                            ...
                            <div className="text_container">
                                <h2>[리커버] 무의미의 축제</h2>
                                <p>글 : 밀란 쿤데라</p>
                                <p>『참을 수 없는 존재의 가벼움』으로 전 세계 독자를 사로잡은<br/>밀란 쿤데라의 마지막 소설</p>
                                <span>자세히 보기</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="page fourth">
                        <div className="container flex">
                            ...
                            <div className="text_container">
                                <h2>보이드 씨의 기묘한 저택</h2>
                                <p>글 : 하지은</p>
                                <p>한국 2세대 환상 문학의 마에스트로 하지은의<br/>시대를 풍미한 걸작 4권 완전판 복간!</p>
                                <span>자세히 보기</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="page fifth">
                        <div className="container flex">
                            ...
                            <div className="text_container">
                                <h2>나의 미국 인문 기행</h2>
                                <p>글 : 서경식<br/>옮김 : 최재혁</p>
                                <p>“그것이 나의 끝나지 않는 ‘인문 기행’의 한 페이지다.”<br/>우리시대의 경계인 서경식의 유작, 분열과 냉소의 미국에서 도덕의 거처를 묻다</p>
                                <span>자세히 보기</span>
                            </div>
                        </div>
                    </div>
